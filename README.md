...
| <a name="input_ecr_ssm_parameters_arn"></a> [ecr\_ssm\_parameters\_arn](#input\_ecr\_ssm\_parameters\_arn) | set of ssm parameters arn to enable access to job | `set(string)` | `[]` | no |
